    ...
    **内部統制テスト評価AIシステム**は、企業の内部監査業務を支援するAIツールです。
    ...
    ├── docs/                    # ドキュメント
    │   ├── README.md                # ドキュメント目次
    │   └── CLOUD_COST_ESTIMATION.md # コスト見積書
    │
    ├── infrastructure/          # インフラ構成管理
    ...
    **ステップ3: Cloud Runへのデプロイ**
    ...
    | 日付 | バージョン | 変更内容 |
    | ---- | ---------- | -------- |
    | 2026-02-14 | 3.0.0 | コンテナベースデプロイ移行（Container Apps/App Runner/Cloud Run）、Azure AI Foundry命名統一、非同期Storage追加、ドキュメント全面更新 |
