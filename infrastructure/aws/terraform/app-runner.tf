...
#
# 【ネットワークセキュリティ】
# - Inbound:  HTTPS (443) API Gateway経由のみ許可
# - Outbound: HTTPS (443) Bedrock / Textract / Secrets Manager
# - 認証:     API Gateway + APIキー / IAMロール
# - 暗号化:   TLS 1.2+（トランジット中）、Secrets Manager（シークレット管理）
#
# ==============================================================================
